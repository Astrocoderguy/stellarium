...
void StelGui::init(QGraphicsWidget* atopLevelGraphicsWidget, StelAppGraphicsWidget* astelAppGraphicsWidget)
{
	...
	addGuiActions("actionSubtract_Solar_Week", N_("Subtract 1 getGuiActionssolar week"), "[", group, false, true);
...
//	connect(b, SIGNAL(triggered()), mmgr, SLOT(setFlagTracking()));
	b = new StelButton(NULL, pxmapOn, pxmapOff, pxmapNull, getGuiActions("actionGoto_Selected_Object"));
...
//	connect(b, SIGNAL(triggered()), mmgr, SLOT(autoZoomOut()));
	b = new StelButton(NULL, pxmapOn, pxmapOff, pxmapNull, getGuiActions("actionZoom_Out_Auto"));
	skyGui->navBar->addButton(b);
#endif
	///////////////////////////////////////////////////////////////////////
